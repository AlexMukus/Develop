...
/// <summary>
/// Конвертер статуса клавиши в цветную кисть.
...
public sealed class KeyStatusToBrushConverter : IValueConverter
{
    ...
    /// <summary>
    /// Создаёт кисть для указанного статуса клавиши.
    /// </summary>
    public static SolidColorBrush CreateBrush(KeyStatus status) => status switch
    {
        KeyStatus.NotTested => new SolidColorBrush(Color.FromRgb(0x50, 0x50, 0x50)),
        KeyStatus.Ok => new SolidColorBrush(Color.FromRgb(0x2E, 0xCC, 0x71)),
        KeyStatus.Warning => new SolidColorBrush(Color.FromRgb(0xF1, 0xC4, 0x0F)),
        KeyStatus.Critical => new SolidColorBrush(Color.FromRgb(0xE7, 0x4C, 0x3C)),
